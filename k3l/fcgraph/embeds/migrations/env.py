"""Alembic environment for k3l.fcgraph.embeds migrations."""
...
# Interpret the config file for Python logging unless we're in offline mode
if config.config_file_name is not None:
    fileConfig(config.config_file_name)

# Target metadata for 'autogenerate' support
# This will be set by the MigrationManager when needed
